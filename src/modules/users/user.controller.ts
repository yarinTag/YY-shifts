...
class UserController {
 ...
 public verifyToken = async (req: Request, res: Response, next: NextFunction): Promise<Response> => {
  ...
  public updateUser = async (
    ...
    try {
      const updateUser = await this.userService.updateUser(req.body,req.cookies.token);
